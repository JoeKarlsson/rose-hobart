...
describe('ImagesPicker', () => {
	let wrapper;
	let inst;
	const mockhandleChange = jest.fn();

	beforeEach(() => {
		wrapper = shallow(<ImagesPicker handleChange={mockhandleChange} />);
	...
	describe('rendering', () => {
		describe('initial state', () => {
			it('match the snapshot', () => {
				const component = renderer.create(<ImagesPicker handleChange={mockhandleChange} />);
